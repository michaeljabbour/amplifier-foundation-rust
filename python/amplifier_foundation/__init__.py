...
# =============================================================================
# Rust acceleration: override pure Python implementations with Rust where
# available. The _engine module is a compiled Rust extension (built by maturin).
# If it's not installed, everything falls back to the pure Python above.
# =============================================================================
try:
    from amplifier_foundation._engine import (  # noqa: F811
        # Functions
        parse_uri as parse_uri,
        normalize_path as normalize_path,
        deep_merge as deep_merge,
        merge_module_lists as merge_module_lists,
        parse_mentions as parse_mentions,
        generate_sub_session_id as generate_sub_session_id,
        validate_bundle as validate_bundle,
        validate_bundle_or_raise as validate_bundle_or_raise,
        validate_bundle_completeness as validate_bundle_completeness,
        validate_bundle_completeness_or_raise as validate_bundle_completeness_or_raise,
        apply_provider_preferences as apply_provider_preferences,
        is_glob_pattern as is_glob_pattern,
        sanitize_for_json as sanitize_for_json,
        sanitize_message as sanitize_message,
        format_directory_listing as format_directory_listing,
        get_amplifier_home as get_amplifier_home,
        construct_agent_path as construct_agent_path,
        construct_context_path as construct_context_path,
        parse_frontmatter as parse_frontmatter,
        get_nested as get_nested,
        get_nested_with_default as get_nested_with_default,
        set_nested as set_nested,
        # Session functions
        count_turns as count_turns,
        get_turn_boundaries as get_turn_boundaries,
        slice_to_turn as slice_to_turn,
        find_orphaned_tool_calls as find_orphaned_tool_calls,
        add_synthetic_tool_results as add_synthetic_tool_results,
        get_turn_summary as get_turn_summary,
        fork_session as fork_session,
        fork_session_in_memory as fork_session_in_memory,
        get_fork_preview as get_fork_preview,
        list_session_forks as list_session_forks,
        get_session_lineage as get_session_lineage,
        count_events as count_events,
        get_event_summary as get_event_summary,
    )
