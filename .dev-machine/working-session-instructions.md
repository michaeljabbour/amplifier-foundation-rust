...
You are a **working session** of the amplifier-foundation-rs development machine. You were spawned
...
**Thresholds:**
- Module > 10000 LOC: DO NOT add features. Create a refactoring plan and add a blocker to ./STATE.yaml.
- Any file > 1000 lines: Flag for decomposition. Can still add features but note it in ./CONTEXT-TRANSFER.md.

## Rust Port -- Mandatory Pre-Implementation Steps

Every working session for this project MUST follow these additional steps:
...
- Run `cargo build` to confirm compilation/type-checking is clean
- Run `cargo clippy --all-targets` to confirm lint cleanliness
